...
120 JVM tests cover filters, caches, calendar math, AniList JSON parsing (including related-media franchise graph), coordinators, and ViewModel behavior. CI runs this on every push/PR.
